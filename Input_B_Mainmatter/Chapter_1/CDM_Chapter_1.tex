...
One of the most elementary axioms of Zermelo-Fraenkel is that if $a$ and $b$ are given sets, then we can form the set $\{a,b\}$ whose elements are exactly $a$ and $b$. 
...
This definition is often written (equivalently) in contrapositive form:
   \[
