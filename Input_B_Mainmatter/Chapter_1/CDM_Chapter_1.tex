...
We will also assume familiarity with the concepts of generalized union and intersection: Given a  family $\{A_i \mid i\in I\}$ of sets, the \emph{generalized union} $\bigcup_{i\in I} A_i$ and generalized intersection $\bigcap_{i\in I} A_i$ are defined, respectively, as follows:
