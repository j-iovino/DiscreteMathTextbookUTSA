...
By passing from $A$ to the quotient $A/R$, we identify all the elements equivalent to $a$ as a single element of the quotient: $[a]$. Intuitively, this means that all elements of $A$ that are equivalent to $a$ through $R$ are regarded as the same element.
