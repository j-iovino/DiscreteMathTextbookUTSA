...
This definition is often written (equivalently) in contrapositive form:
 ...
 $f[f^{-1}[B_0]]\subseteq B_0$.
\item[(\theenumi)*] 
 For the parts above where your answer was ``false'' determine the exact condition on $f$ that is needed to make the answer ``true'f for arbitrary $A_0\subseteq A$ and $B_0\subseteq B$.
 \end{enumerate}
 \end{exercise}
...
\end{align*}
 ...
 \item
 $f^{-1}[\bigcup_{i\in I} B_i] \subseteq  \bigcup_{i\in I} f^{-1}[B_i]$.
 \item
 $f^{-1}[\bigcap_{i\in I}B_i] \supseteq  \bigcap_{i\in I} f^{-1}[B_i]$.
      \stepcounter{enumi}
 \item[(\theenumi)*] 
