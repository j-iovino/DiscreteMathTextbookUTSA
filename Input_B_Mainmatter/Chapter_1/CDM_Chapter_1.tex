...
\begin{remark}
Note that $\bigcap_{i\in I} A_i $ can only be defined when the index set $I$ is nonempty. If $I$ were empty, then $\bigcap_{i\in I} A_i $ would be the universe (the set of all sets), which cannot exist due to Russell's paradox.
\end{remark}
