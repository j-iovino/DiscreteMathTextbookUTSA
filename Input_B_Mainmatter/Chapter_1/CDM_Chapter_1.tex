...
Note that $(a,b)$ is not equal to $(b,a)$ (unless, of course, $a,b$).
...
Nevertheless, we summarize it here. If $A,B$ are sets, a function $f:A\to B$ is intuitively a ``rule'' that to every $a\in A$ assigns a unique $b\in B$. 
