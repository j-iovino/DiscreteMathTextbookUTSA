...
Similarly, we define ordered triples, quadruples, quintuples, and, in genral $n$ tupkles $(a_1,\dots, a_n)$ for any nonnegative integer $n$.
If $A$ is a set, the set of $n$-tuples $(a_1,\dots, a_n)$ with $a_1,\dots, a_n\in A$ is denoted $A^n$.

For this course, we will assume that participants are familiar and completely comfortable with the notion of function, the arrow notation $f\colon A\to B$, and the concepts of injective and surjective functions.

We will also assume familiarity with the concept of cartesian product of sets, and with the concepts $\bigcup_{i\in I} A_i$ and $\bigcap_{i\in I} A_i$ of generalized union and intersection of a family $\{A_i\}_{i\in I}$ of sets.
