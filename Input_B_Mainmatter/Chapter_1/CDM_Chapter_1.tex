...
\end{align*}
 ...
 $f^{-1}[\bigcap_{i\in I}B_i] \supseteq  \bigcap_{i\in I} f^{-1}[B_i]$.
      \stepcounter{enumi}
 \item[(\theenumi)*] 
 For the parts above where your answer was ``false'' determine the exct condition on $f$ that is needed to make the answer ``true'' for arbitrary indexed families $\{A_i \mid i\in I\}, \{B_i \mid i\in I\}$  of subsets of $A,B$ respectively.
